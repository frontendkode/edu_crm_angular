...
export class AllApiService {
  ...
  createDropDown(payLoad: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-dropdown/create`, payLoad)
  }

  getAllDropDown(): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-dropdown/getAll`, {})
  }

  updateDropDown(payLoad: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-dropdown/update`, payLoad)
  }
  getDashboardData(payLoad?: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-das-board/getDashBoardDatas`, {})
  }



  getAllNotification(): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-das-board/getDailyNotification`, {})
  }

  getAllLead(): Observable<any> {

    return this.http.post(`${this.baseUrl}/kiss-tech/api-lead/getAllLeads`, {});
  }

  createLead(payLoad: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-lead/create`, payLoad);
  }

  updateLeadStage(id: any, stage: any): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/kiss-tech/api-lead/updateStage?id=${id}&stage=${stage}`, {});
  }
  updateLeadRimLog(id: any, payLoad: any): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/kiss-tech/api-lead/updateReminder?leadId=${id}`, payLoad);
  }

  updateLeadActLog(id: any, payLoad: any): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/kiss-tech/api-lead/updateActivity?leadId=${id}`, payLoad);
  }


  //students api
  getAllStudents(): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-student/getAllStudents`, {});
  }

  createStudents(payLoad: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-student/create`, payLoad);
  }

  enrollStudent(payLoad: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-student/update`, payLoad);
  }
  ...
  makeStudentPayment(dueDayId: any, status: any, studentId: any, mode: any, time: any): Observable<any> {
    ...
    return this.http.post<any>(`${this.baseUrl}/kiss-tech/api-student/updatePaymentDetails?${queryParams}`, {});
  }
  ...
  makeStudentAttendance(attendanceId: any, status: any): Observable<any> {
    ...
    return this.http.post<any>(`${this.baseUrl}/kiss-tech/api-student/updateAttendanceDetails?${queryParams}`, {});
  }


  getAllStaff(): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-staff/getAllStaffsWithTask`, {})
  }

  addStaff(member: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-staff/create`, member);
  }
  ...
  createTaskAndAssign(payLoad: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-task/create`, payLoad)
  }

  getAllTasks(): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-task/getAllTasks`, {})
  }

  changeTaskStatus(taskId: string, newStatus: string): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-task/taskStatusUpdateById?id=${taskId}&status=${newStatus}`, {});
  }

  getAllStaffAndIds(): Observable<any> {
    return this.http.post(`${this.baseUrl}/kiss-tech/api-staff/getAllStaffNameAndId`, {})
  }
